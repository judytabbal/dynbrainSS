function results = go_decomposeConnectome_general_pca(opt,varagin)
...
% load and concatenate all the data for PCA. 
...
[coeff, score, latent, tsquared, explained] = pca(cmat_all,'NumComponents', opt.NICs);
coeff_prime=coeff';
