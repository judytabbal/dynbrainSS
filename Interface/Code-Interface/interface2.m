...
global files_base
files_base = 'C:\Users\imanm\Desktop\PhD\Matlab\dynBrainSS_2\Interface\Data-Interface2';
files_base2 = 'C:\Users\imanm\Desktop\PhD\Matlab\dynBrainSS_2';

subject1 = { '104012'};
for i=1:length(subject1)
    cmat_list{i} = [files_base '\1-Motor_Self-paced\' subject1{i} '_LH1-30100_alldemo.mat'];  
end
